...
CollectionHooks.defineAdvice('insert', function (userId, _super, instance, aspects, getTransform, args, suppressAspects) {
  ...
  // console.log("_SUPER ID IS ", _super);
  // console.log("INSTANCE ID IS ", instance);
  // console.log("ASPECTS ID IS ", aspects);
  // console.log("GETTRANSFORM ID IS ", getTransform);
  console.log("INSERT ARGS ARE ", args);
  // console.log("SUPRESSASPECTS ID IS ", suppressAspects);
    
    console.log("INSERT ARGS 0 ", args[0]);
    console.log("INSERT ARGS 1 ", args[1]);
    console.log("INSERT ARGS 2 ", args[2]);
    ...
    // console.log("DOC IS WHAT  ", args[0]);
